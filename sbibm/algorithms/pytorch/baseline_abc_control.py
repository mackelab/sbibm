...
def run(
    ...
    **kwargs: Any,
    ...
    """Random samples from rejection ABC using bounds of reference posterior for truncation of prior support
    ...
    Args:
        ...
        batch_size: Batch size used for simulations
        kwargs: Not used
    ...
    log.info("Rejection ABC baseline with reference posterior bounds")
